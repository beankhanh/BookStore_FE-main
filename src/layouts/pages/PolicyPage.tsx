	...
	return (
		<div className='container my-5 bg-super-light p-4 rounded'>
			...
			<p>
				...
				khuyết, hư hỏng hoặc không như mô tả, VKBOOK cam kết bảo vệ khách
			...
			<p>
				...
				<a href='#!chinh-sach-doi-tra-hang'>
					<strong>vkbook.com/chinh-sach-doi-tra-hang</strong>
				</a>{" "}
			...
			<ul>
				<li>
					<p>Quý khách vui lòng thông báo về cho VKBOOK ngay khi:</p>
					<p>
						{" "}
				...
				<li>
					<p>
						Sau khi VKBOOK xác nhận mail tiếp nhận yêu cầu kiểm tra xử
						lý, VKBOOK sẽ liên hệ đến quý khách để xác nhận thông tin
						hoặc nhờ bổ sung thông tin (nếu có). Trường hợp không liên hệ
						được VKBOOK rất tiếc xin được phép từ chối xử lý yêu cầu.
						Thời gian VKBOOK liên hệ trong giờ hành chính tối đa 3 lần
			...
			<p>
				...
				<strong>VKBOOK</strong> trong vòng 30 ngày kể từ khi nhận hàng với
			...
			<br />
			<p>
				<strong>VKBOOK</strong> hỗ trợ đổi/ trả sản phẩm cho quý khách nếu:
			</p>
			<ul>
				<li>
			...
			<ul>
				<li>
					<p>
						...
						<strong>cskh@vkbook.com.vn</strong> với tiêu đề{" "}
			...
			<ul>
				<li>
					Để đảm bảo quyền lợi khách hàng và để <strong>VKBOOK</strong> có
					...
					clip từ quý khách, <strong>VKBOOK</strong> xin phép từ chối hỗ
					trợ.
				</li>
			</ul>
			<table
			...
			>
				<tbody>
					...
					<tr>
						...
						<td>
							<p>VKBOOK có sản phẩm→ đổi mới cùng sản phẩm</p>
							<p>
								VKBOOK hết hàng→ Hoàn tiền hoặc quý khách có thể chọn
								mặt hàng khác tại website{" "}
								<span style={{ textDecoration: "underline" }}>
									<a href='#!'>www.vkbook.com</a>
								</span>
								.
							</p>
					...
					<tr>
						...
						<td>
							...
							<p>
								**Lưu ý: VKBOOK rất tiếc sẽ không hỗ trợ hoàn lại chi
