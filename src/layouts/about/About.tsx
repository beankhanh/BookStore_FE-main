	...
	return (
		<div className='w-100 h-100 d-flex align-items-center justify-content-center flex-column m-5'>
			<div className='w-50 h-50 p-3 rounded-5 shadow-4-strong bg-light'>
				<h3 className='text-center text-black'>Giới thiệu về VKBOOK</h3>
				<hr />
				<div className='row'>
					<div className='col-lg-8'>
						<p>
							<strong>Tên website: </strong>VKBOOK
						</p>
						<p>
							<strong>Địa chỉ: </strong>Số 2, Ngõ 72, P.Đình Quán, huyện Nam Từ Liêm, Hà Nội
						</p>
						<p>
							<strong>Số điện thoại: </strong>0398157635
						</p>
						<p>
							<strong>Email: </strong>beankhanh2001@gmail.com
						</p>
					</div>
